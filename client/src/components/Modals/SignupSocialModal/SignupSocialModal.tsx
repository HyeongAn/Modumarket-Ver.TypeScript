...
function SignupSocialModal() {
    ...
    const userSocialId = useSelector((state :RootState) => state.modal.socialInfoId);
    const userSocialEmail = useSelector((state :RootState) => state.modal.socialInfoEmail);
    const userSocial = useSelector((state :RootState) => state.userInfo.userStatus)

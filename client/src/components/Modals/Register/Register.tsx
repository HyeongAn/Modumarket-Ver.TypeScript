...
function Register() {
    ...
    const handleInputValue = (key : string) => (e : any) => { // onChange 가 발생할 경우 값을 넣어주는 함수
            ...
            <ModalContainer>
                ...
                <PhotoWrap>
                    ...
                    <input
                        ...
                        onChange={(e : any) => { onLoadFile(e.target.files[0]) }} />
                </PhotoWrap>
                <PhotoSearch>
                    <Photo>
                ...
                <DateWrap>
                    <p>마감 날짜 선택</p>
                    <EndDate minDate={new Date()} locale={ko} dateFormat="yyyy년 MM월 dd일" selected={endDate} onChange={(date : any) => setEndDate(date)} />
                </DateWrap>
                <PostLocationWrap>
                    <p>만남장소</p>
                    <PostLocation>

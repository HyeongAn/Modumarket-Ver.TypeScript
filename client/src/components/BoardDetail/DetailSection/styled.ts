...
export const HeadButton = styled.div<styledProps>`
  ...
  width: 6rem;
  border-radius: 4px;
  border: ${(props) => (props.background === "#FF6767" ? 0 : "thin")};
  border-color: ${(props) =>
    props.background === "#FF6767" ? "white" : "#848484"};
  color: ${(props) => (props.background === "#FF6767" ? "white" : "#848484")};
  height: 2rem;
  border-style: solid;
`;
...
export const DetailPhoto = styled.div<styledProps>`
  img {
    width: ${(props) => (props.image === "" ? "17.145rem" : "22rem")};
    height: ${(props) => (props.image === "" ? "15rem" : "13rem")};

    @media (min-width: 480px) {
      width: ${(props) => (props.image === "" ? "21.717rem" : "27.1rem")};
      height: ${(props) => (props.image === "" ? "19rem" : "16rem")};
    }
    @media (min-width: 767px) {
      width: ${(props) => (props.image === "" ? "26.289rem" : "32.18rem")};
      height: ${(props) => (props.image === "" ? "23rem" : "19rem")};
    }
    @media (min-width: 1024px) {
      width: ${(props) => (props.image === "" ? "32rem" : "40rem")};
      height: ${(props) => (props.image === "" ? "28rem" : "24.6rem")};
    }
  }
`;

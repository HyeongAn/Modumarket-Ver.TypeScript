...
function MyPage() {
    ...
    const userImg = useSelector((state : RootState) => state.userInfo.userImg);
    const accessToken = useSelector((state : RootState) => state.login.accessToken);
    const myWritePost = useSelector((state : RootState) => state.mypost.writePost);
    const myPartyPost = useSelector((state : RootState) => state.mypost.participatePost);
    const isWriteNull = useSelector((state : RootState) => state.mypost.isWriteNull);
    const isPartyNull = useSelector((state : RootState) => state.mypost.isPartyNull);
